...
const baseStandards: MockStandardSeed[] = standardTitles.map((title, i) => ({
  ...
  standardCode: `STD-${String(i + 1).padStart(3, '0')}`,
  title,
...
const checklistItemsMap: Record<string, ChecklistItem[]> = {
  ...
  'chk-002': [
    ...
    },
    {
      ...
      controlFrequency: 'per_occurrence',
      evaluationType: 'operation',
      organizationIds: ['org-purchase', 'org-legal'],
    },
  ],
  'chk-003': [
    {
      ...
      evaluationType: 'operation',
      organizationIds: ['org-asset', 'org-finance'],
    },
    {
      id: 'ci-009',
      checklistId: 'chk-003',
